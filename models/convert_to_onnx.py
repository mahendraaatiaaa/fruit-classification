...
def convert_to_onnx(model, img_height, img_width, onnx_filename):
    try:
        # Muat model dari file
        model = SimpleNet2D(num_classes=10, img_height=img_height, img_width=img_width)
        ...
        torch.onnx.export(
            ...
            opset_version=12,       # Versi opset ONNX (gunakan yang sesuai dengan kebutuhan Anda)
...
onnx_filename = 'model2.onnx'

# Konversi model ke ONNX
if __name__ == "__main__":
    model_path = 'model2.pth'  # Ganti dengan model Anda
